...
class SearchForm extends HTMLElement {
  constructor() {
    ...
    this.inputElement.setAttribute('data-use-keyboard', true); // add virtual keyboard support
    this.searchButton = document.createElement('button');
    this.searchButton.setAttribute('type', 'button');
    this.searchButton.innerHTML = `
      <svg viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" style="transform: scale(-1, 1);">
